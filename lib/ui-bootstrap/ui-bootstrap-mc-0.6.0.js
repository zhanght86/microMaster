...
angular.module('ui.bootstrap.switch', [])
    .constant('switchConfig', {
        onText: 'on',
        offText: 'off'
    })
    .directive('switch', ['$compile', 'switchConfig', function ($compile, switchConfig) {

        var onText = switchConfig.onText || 'on';
        var offText = switchConfig.offText || 'off';
        ...
        return {
            ...
            link:function (scope, element, attrs, switchCtroller) {
    ...
    .controller('SwitchController', ['$scope', '$attrs', '$compile', function ($scope, $attrs, $compile) {
